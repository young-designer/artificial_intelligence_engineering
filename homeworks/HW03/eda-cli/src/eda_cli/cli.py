...
def report(
    ...
    # ДОБАВЛЕНО: Новые параметры для настройки отчета
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        if not top_cats:
            ...
            # ДОБАВЛЕНО: Информация о количестве top-значений
            f.write(f"Показаны топ-{top_k_categories} значений для каждого категориального признака.\n\n")
